...
namespace Nz.Tests.Auth
{
    ...
    public abstract class AuthTestsBase
    {
        ...
        {
            return $"nz_auth_tests_{Common.Helpers.GenerateRandonIdentifier()}";
        }
        ...
        {
            HttpResponseMessage response = Task.Run(() => HttpClient.GetAsync(Auth.HealthCheck_v1_0))
                .GetAwaiter()
                .GetResult();
